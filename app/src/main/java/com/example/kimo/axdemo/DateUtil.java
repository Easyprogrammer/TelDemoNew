...
public class DateUtil {
     ...
     * @return
     */
//    public static int getNowToMidNight () {
//    	Calendar now = Calendar.getInstance();
//    	int hour = now.get(Calendar.HOUR_OF_DAY);
//    	int min = now.get(Calendar.MINUTE);
//    	int second = now.get(Calendar.SECOND);
//    	int cleanTime = ((24 - hour) * 60 * 60 - min * 60 - second);
//    	//int cleanTime = ((20 - hour) * 60 * 60 - min * 60 - second);
//    	logger.info("【超频清除时间】hour={} , min={} , second={} , cleanTime={}",hour,min,second,cleanTime);
//    	return cleanTime;
//    }
}
